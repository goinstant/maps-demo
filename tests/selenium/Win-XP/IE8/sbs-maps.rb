...
class SbsMaps < Test::Unit::TestCase
  ...
  def test_sbs_maps
    ...
    #sleep(2.5)
    #assert !5.times{ break if (element_present?(:xpath, "/html/body/div[6]/div") rescue false); sleep 1 }
    ...
    verify { assert !element_present?(:xpath, "/html/body/div[6]/div/span") }
    ...
    @driver.switch_to.default_content
    @driver.switch_to.frame "demo-left"
    @driver.find_element(:xpath, "/html/body/div[6]/div/span").click
    verify { assert element_present?(:xpath, "/html/body/div[6]/div") }
    @driver.switch_to.default_content
    @driver.switch_to.frame "demo-right"
    @driver.find_element(:xpath, "/html/body/div[6]/div/span").click
    verify { assert element_present?(:xpath, "/html/body/div[6]/div") }
    ...
    assert !5.times{ break if (element_present?(:xpath, "/html/body/div[5]/div[1]") rescue false); sleep 1 }
    @driver.switch_to.default_content
    @driver.switch_to.frame "demo-right"
    @driver.find_element(:id, "search-bar").send_keys "new york"
    assert !5.times{ break if (element_present?(:xpath, "/html/body/div[5]/div[1]") rescue false); sleep 1 }
    ...
    zoom = 9
    while i <= zoom do
      @driver.find_element(:xpath, "//*[@id='map-canvas']/div/div[8]/div[2]/div[2]").click
      i +=1
    end
    assert !5.times{ break if (element_present?(:xpath, "//*[@id='map-canvas']/div/div[8]/div[1]/div") rescue false); sleep 1 }
    @driver.switch_to.default_content
    @driver.switch_to.frame "demo-left"
    assert !5.times{ break if (element_present?(:xpath, "//*[@id='map-canvas']/div/div[8]/div[1]/div") rescue false); sleep 1 }
  end
